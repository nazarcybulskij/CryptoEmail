...
public abstract class EmailContent {
    ...
    public static final String AUTHORITY = "com.indeema.email.provider";
    ...
    public static final String NOTIFIER_AUTHORITY = "com.indeema.email.notifier";
    ...
    public static final String PROVIDER_PERMISSION = "com.indeema.email.permission.ACCESS_PROVIDER";
