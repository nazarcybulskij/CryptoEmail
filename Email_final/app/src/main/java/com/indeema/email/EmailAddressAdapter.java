...
import com.indeema.common.contacts.BaseEmailAddressAdapter;
import com.indeema.emailcommon.provider.Account;

/**
 * An adaptation of {@link com.indeema.common.contacts.BaseEmailAddressAdapter} for the Email app. The main
...
public class EmailAddressAdapter extends BaseEmailAddressAdapter implements AccountSpecifier {
    ...
    protected View inflateItemView(ViewGroup parent) {
        return mInflater.inflate(com.indeema.email.R.layout.recipient_dropdown_item, parent, false);
    }

    @Override
    protected View inflateItemViewLoading(ViewGroup parent) {
        return mInflater.inflate(com.indeema.email.R.layout.recipient_dropdown_item_loading, parent, false);
    }

    @Override
    protected void bindView(View view, String directoryType, String directoryName,
            String displayName, String emailAddress) {
      TextView text1 = (TextView)view.findViewById(com.indeema.email.R.id.text1);
      TextView text2 = (TextView)view.findViewById(com.indeema.email.R.id.text2);
    ...
    protected void bindViewLoading(View view, String directoryType, String directoryName) {
        TextView text1 = (TextView)view.findViewById(com.indeema.email.R.id.text1);
        String text = getContext().getString(com.indeema.email.R.string.gal_searching_fmt,
