 ...
 */
public class ShortcutPicker extends Activity implements OnClickListener, ShortcutPickerFragment.PickerCallback {
    /**
    ...
    public Integer buildFilter(Account account) {
        ...
        return ShortcutPickerFragment.MailboxShortcutPickerFragment.FILTER_ALLOW_ALL;
    }
