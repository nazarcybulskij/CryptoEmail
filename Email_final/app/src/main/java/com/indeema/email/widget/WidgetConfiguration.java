...
package com.indeema.email.widget;
...
import com.indeema.email.activity.ShortcutPickerFragment;

/**
 * Activity to configure the Email widget.
 */
public class WidgetConfiguration extends Activity implements OnClickListener, ShortcutPickerFragment.PickerCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getFragmentManager().findFragmentById(R.id.shortcut_list) == null) {
            ...
            ShortcutPickerFragment.AccountShortcutPickerFragment fragment = new ShortcutPickerFragment.AccountShortcutPickerFragment();
    ...
    public Integer buildFilter(Account account) {
        if (!Account.isNormalAccount(account.mId)) {
            return ShortcutPickerFragment.MailboxShortcutPickerFragment.FILTER_INBOX_ONLY
                    | ShortcutPickerFragment.MailboxShortcutPickerFragment.FILTER_ALLOW_UNREAD;
        }
        ...
        return HostAuth.SCHEME_EAS.equals(account.getProtocol(this))
                ? ShortcutPickerFragment.MailboxShortcutPickerFragment.FILTER_ALLOW_ALL
                : ShortcutPickerFragment.MailboxShortcutPickerFragment.FILTER_INBOX_ONLY;
    }
