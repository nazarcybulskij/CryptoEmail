...
public class FolderProperties {
    ...
    private FolderProperties(Context context) {
        ...
        mSpecialMailbox = context.getResources().getStringArray(com.indeema.email.R.array.mailbox_display_names);
        ...
        mSpecialMailboxDrawable =
            context.getResources().obtainTypedArray(com.indeema.email.R.array.mailbox_display_icons);
        mSummaryStarredMailboxDrawable =
            context.getResources().getDrawable(com.indeema.email.R.drawable.ic_menu_star_holo_light);
        mSummaryCombinedInboxDrawable =
            context.getResources().getDrawable(com.indeema.email.R.drawable.ic_list_combined_inbox);
    }
    ...
    public String getCombinedMailboxName(long mailboxId) {
        ...
        if (mailboxId == Mailbox.QUERY_ALL_INBOXES) {
            resId = com.indeema.email.R.string.account_folder_list_summary_inbox;
        } else if (mailboxId == Mailbox.QUERY_ALL_FAVORITES) {
            resId = com.indeema.email.R.string.account_folder_list_summary_starred;
        } else if (mailboxId == Mailbox.QUERY_ALL_DRAFTS) {
            resId = com.indeema.email.R.string.account_folder_list_summary_drafts;
        } else if (mailboxId == Mailbox.QUERY_ALL_OUTBOX) {
            resId = com.indeema.email.R.string.account_folder_list_summary_outbox;
        }
        if (resId != 0) {
