...
import com.indeema.email.activity.setup.AccountSettingsEditQuickResponsesFragment;
...
public class InsertQuickResponseDialog extends DialogFragment
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        new AccountSettingsEditQuickResponsesFragment.QuickResponseFinder(mTaskTracker, account.mId, mQuickResponsesView,
