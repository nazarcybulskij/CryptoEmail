...
public class Email extends Application {
    ...
    public void onCreate() {
        ...
        sMessageDecodeErrorString = getString(com.indeema.email.R.string.message_decode_error);
