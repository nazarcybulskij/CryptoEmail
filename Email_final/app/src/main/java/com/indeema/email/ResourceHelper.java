...
public class ResourceHelper {
    ...
    private ResourceHelper(Context context) {
        ...
        mAccountColorArray = mResources.obtainTypedArray(com.indeema.email.R.array.combined_view_account_colors);
        mAccountColors = mResources.getIntArray(com.indeema.email.R.array.combined_view_account_colors);
