 ...
 *   - Either an actual account ID, or {@link com.indeema.emailcommon.provider.Account#ACCOUNT_ID_COMBINED_VIEW}.
 *
 ...
 *
 * - "Highlighted" mailbox
 *   - Only used when highlighting is enabled.  (Otherwise always {@link com.indeema.emailcommon.provider.Mailbox#NO_MAILBOX}.)
 ...
 * <pre>
 * 1. Combined view
 *   - Used if the account ID == {@link com.indeema.emailcommon.provider.Account#ACCOUNT_ID_COMBINED_VIEW}.
 *   - Parent mailbox is always {@link com.indeema.emailcommon.provider.Mailbox#NO_MAILBOX}.
 *   - List contains:
 *     - combined mailboxes
 *     - all accounts
 *
 * 2. Root view for an account
 *   - Used if the account ID != {@link com.indeema.emailcommon.provider.Account#ACCOUNT_ID_COMBINED_VIEW} and
 *     Parent mailbox == {@link com.indeema.emailcommon.provider.Mailbox#NO_MAILBOX}
 *   - List contains
...
public class MailboxListFragment extends ListFragment implements OnItemClickListener,
    ...
    public interface Callback {
         ...
         *          Or {@link com.indeema.emailcommon.provider.Account#ACCOUNT_ID_COMBINED_VIEW} if it's a combined mailbox.
         * @param mailboxId
