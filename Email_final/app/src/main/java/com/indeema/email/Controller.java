...
import com.indeema.email.mail.store.Pop3Store.Pop3Message;
...
import com.indeema.emailcommon.Api;
...
//            }
    ...
    public static String getMailboxServerName(Context context, int mailboxType) {
        ...
        switch (mailboxType) {
            case Mailbox.TYPE_INBOX:
                resId = com.indeema.email.R.string.mailbox_name_server_inbox;
                break;
            case Mailbox.TYPE_OUTBOX:
                resId = com.indeema.email.R.string.mailbox_name_server_outbox;
                break;
            case Mailbox.TYPE_DRAFTS:
                resId = com.indeema.email.R.string.mailbox_name_server_drafts;
                break;
            case Mailbox.TYPE_TRASH:
                resId = com.indeema.email.R.string.mailbox_name_server_trash;
                break;
            case Mailbox.TYPE_SENT:
                resId = com.indeema.email.R.string.mailbox_name_server_sent;
                break;
            case Mailbox.TYPE_JUNK:
                resId = com.indeema.email.R.string.mailbox_name_server_junk;
                break;
        }
    ...
    public class MessageRetrievalListenerBridge implements MessageRetrievalListener {
        ...
        @Override
        public void messageRetrieved(com.indeema.emailcommon.mail.Message message) {
        }
    }
