...
public class MailService extends Service {
    ...
    private static final String ACTION_CHECK_MAIL =
        "com.indeema.email.intent.action.MAIL_SERVICE_WAKEUP";
    private static final String ACTION_RESCHEDULE =
        "com.indeema.email.intent.action.MAIL_SERVICE_RESCHEDULE";
    private static final String ACTION_CANCEL =
        "com.indeema.email.intent.action.MAIL_SERVICE_CANCEL";
    private static final String ACTION_SEND_PENDING_MAIL =
        "com.indeema.email.intent.action.MAIL_SERVICE_SEND_PENDING";
    private static final String ACTION_DELETE_EXCHANGE_ACCOUNTS =
        "com.indeema.email.intent.action.MAIL_SERVICE_DELETE_EXCHANGE_ACCOUNTS";

    private static final String EXTRA_ACCOUNT = "com.indeema.email.intent.extra.ACCOUNT";
    private static final String EXTRA_ACCOUNT_INFO = "com.indeema.email.intent.extra.ACCOUNT_INFO";
    private static final String EXTRA_DEBUG_WATCHDOG = "com.indeema.email.intent.extra.WATCHDOG";
