...
import com.indeema.email.RequireManualSyncDialog;
import com.indeema.email.activity.setup.AccountSettings;
import com.indeema.email.activity.setup.MailboxSettings;
...
abstract class UIControllerBase implements MailboxListFragment.Callback,
    ...
    /**
     * @return the currently selected account ID, *or* {@link com.indeema.emailcommon.provider.Account#ACCOUNT_ID_COMBINED_VIEW}.
     *
