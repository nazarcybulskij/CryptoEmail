    ...
    private static int getErrorStringResourceId(MessagingException e) {
        switch (e.getExceptionType()) {
            case MessagingException.IOERROR:
                return com.indeema.email.R.string.account_setup_failed_ioerror;
            case MessagingException.ATTACHMENT_NOT_FOUND:
                return com.indeema.email.R.string.attachment_not_found;
            case MessagingException.TLS_REQUIRED:
                return com.indeema.email.R.string.account_setup_failed_tls_required;
            case MessagingException.AUTH_REQUIRED:
                return com.indeema.email.R.string.account_setup_failed_auth_required;
            case MessagingException.GENERAL_SECURITY:
                return com.indeema.email.R.string.account_setup_failed_security;
            ...
            case MessagingException.ACCESS_DENIED:
                return com.indeema.email.R.string.account_setup_failed_access_denied;
            case MessagingException.CLIENT_CERTIFICATE_ERROR:
                return com.indeema.email.R.string.account_setup_failed_certificate_inaccessible;
        }
        return com.indeema.email.R.string.status_network_error; // default
    }
}
