...
import com.indeema.email.provider.WidgetProvider.WidgetService;
...
public class EmailWidget implements RemoteViewsService.RemoteViewsFactory,
     ...
     */
    private static final String WIDGET_DATA_MIME_TYPE = "com.indeema.email/widget_data";
    ...
    /**
     * Called back by {@link com.indeema.email.provider.WidgetProvider.WidgetService} to
