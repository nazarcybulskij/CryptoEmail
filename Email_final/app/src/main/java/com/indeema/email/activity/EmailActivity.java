...
import com.indeema.email.ControllerResultUiThreadWrapper;
...
public class EmailActivity extends Activity implements View.OnClickListener, FragmentInstallable {
     ...
     * {@link com.indeema.emailcommon.provider.Mailbox#QUERY_ALL_INBOXES}) don't work.
     */
     ...
     *
     * @param accountId ID of the account for the mailbox.  Must not be {@link com.indeema.emailcommon.provider.Account#NO_ACCOUNT}.
     * @param mailboxId ID of the mailbox to search, or {@link com.indeema.emailcommon.provider.Mailbox#NO_MAILBOX} to perform
     *     global search.
